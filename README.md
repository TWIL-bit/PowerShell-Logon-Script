...
I already have security groups apart of the Groups OU but the users inside didn’t automatically inherit the GPO so I didn’t see any new mappings at first. I added one of the users to the Groups OU directly and I can now see the mapped drive.
 <br>
<br>
